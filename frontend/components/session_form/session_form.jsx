...
class SessionForm extends React.Component {
  ...
  update(frmType, field) {
    ...
    return e =>
      this.setState({
        [frmType]: Object.assign(this.state[frmType], {
        ...
        <div className="contentWrapper">
          ...
          <div className="baseSignUpContainer">
            ...
            <h2 className="tagline">
              Where questions are asked, answered, and edited by users.
            </h2>
                      ...
                      <div className="formInputs">
                        <div className="formColumn">
                          <input
                            ...
                            id="emailInput"
                            placeholder="Email"
                            className="text headerLoginTextBox"
                        ...
                        <div className="formColumn">
                          ...
                          <input
                            type="hidden"
                            name="email"
                            value="ajakubczyk0@tiny.cc"
                          />
                          <button
                            id="demoButton"
                            onClick={() => {
                              this.state = this.props.demo_user;
                            }}
